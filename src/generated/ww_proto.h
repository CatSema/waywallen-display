...
#define WW_PROTOCOL_NAME    "waywallen-display-v9"
#define WW_PROTOCOL_VERSION 9
...
typedef enum waywallen_transition_kind {
...
typedef struct waywallen_transition_config {
    waywallen_transition_kind_t kind;
    uint32_t duration_ms;
    uint32_t angle;
    float origin_x;
    float origin_y;
} waywallen_transition_config_t;
